            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col gap-3 text-gray-600 leading-relaxed">
                ...
                {items.descriptionTwo && (
                  <p className="text-sm opacity-80">{items.descriptionTwo}</p>
                )}
              </div>
            </div>
      ...
      <div className="px-4 sm:px-6 mt-16 sm:mt-20 md:mt-24">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto px-4">
            Making a difference in millions of lives through innovative
            insurance solutions
          </p>
        </div>
      ...
      <div className="px-4 md:px-6 mt-32 mb-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Comprehensive insurance solutions designed for the modern digital
            lifestyle
          </p>
        </div>
